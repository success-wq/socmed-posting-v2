...
const CONFIG = {
    ...
    N8N_TEXT_WEBHOOK: 'http://localhost:5678/webhook/socmedposting-text',
    N8N_IMAGE_WEBHOOK: 'http://localhost:5678/webhook/socmedposting-media',
    N8N_PUBLISH_WEBHOOK: 'http://localhost:5678/webhook/platform-publish',
    GHL_LOCATION_ID: '',
    GHL_TOKEN: '',
    GHL_USER_ID: ''
};
